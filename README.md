...
## ❓︎ 问答
1. 为什么做成纯前端网站？
   网站后端包括服务器、应用还有数据库。构建并维护这些组件会耗费大量的精力，且为了高仿齐盛的官网，所有的前端与后端数据库格式都需要自行从头搭建，耗时耗力。目前使用的域名qsgz.thw.lol是我的的子域名，一年的续费价格要20美刀，如果再加上云服务器费用一年大约也要20美刀，还有可能的DDOS防护，对钱包的压力过大。尽管纯前端在更新内容上不是很方便，内容都得写死在html里，但目前很多公司都提供免费的纯前端网站部署服务，对一个学生来说0成本显然是更好的选择。
